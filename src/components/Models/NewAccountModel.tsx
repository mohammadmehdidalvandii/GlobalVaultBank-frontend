                    ...
                    <form action="#" className="space-y-4 mt-4">
                        <div className="grid grid-cols-2 sm:grid-col-2 gap-4">
                            <div className="space-y-2">
                                <label htmlFor="" className='label_style dark:text-white'>{t('Customer Name')}*</label>
                                <input type="text" className='input_style mt-2 dark:text-white' />
                            </div>
                            <div className="space-y-2">
                                <label htmlFor="" className='label_style dark:text-white'>{t('Email Address')}</label>
                                <input type="text" className='input_style mt-2 dark:text-white' />
                            </div>
                            <div className="space-y-2">
                                <label htmlFor="" className='label_style dark:text-white'>{t("Phone Number")}</label>
                                <input type="text" className='input_style mt-2 dark:text-white' />
                            </div>
                            <div className="space-y-2">
                                <label htmlFor="" className="label_style dark:text-white">{t("Account Type")} *</label>
                            ...
                            <div className="space-y-2">
                                <label htmlFor="" className="label_style dark:text-white">{t("Base Currency")} *</label>
                                <Select.Root defaultValue=''>
                              ...
                              <div className="space-y-2">
                                <label htmlFor="" className='label_style dark:text-white'>{t("Initial Deposit")}</label>
                                <input type="number" className='input_style mt-2 dark:text-white' />
                            </div>
                              <div className="space-y-2">
                                <label htmlFor="" className='label_style dark:text-white'>{t('Note')}</label>
                                <textarea rows={3} className='input_style mt-2 h-20 w-[565px] dark:text-white'  placeholder={t('Additional notes about the account')}/>
                            </div>
                        </div>
